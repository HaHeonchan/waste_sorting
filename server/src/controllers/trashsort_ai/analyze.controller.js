...
} = require('./prompts.controller');
const { analyzeImageWithLogoDetection } = require('./logo-detector.controller');
const { generateImageHash, getFromCache, saveToCache } = require('./cache.controller');
const { 
    optimizeForTextAnalysis, 
    getImageInfo, 
    isImageTooLarge 
} = require('./image-optimizer.controller');
const { 
    uploadAndStoreImage, 
    deleteImageFromCloudinary,
    getImageUrl,
    testCloudinaryConnection
} = require('./cloudinary-storage.controller');
