...
JSON 형식으로 응답:
{
  ...
  "materialParts": [
    {
      "part": "부위명 (예: 본체, 뚜껑, 라벨, 손잡이 등)",
      "material": "재질 (예: PET, HDPE, 종이, 알루미늄 등)",
      "description": "해당 부위의 특징 설명",
      "disposalMethod": "재활용 수거함에 버리세요"
    }
  ]
}`;
...
JSON 형식으로 응답:
{
  ...
  "materialParts": [
    {
      "part": "부위명 (예: 본체, 뚜껑, 라벨, 손잡이, 스프레이 노즐 등)",
      "material": "재질 (예: PET, HDPE, LDPE, PP, 종이, 알루미늄, 스테인리스 등)",
      "description": "해당 부위의 특징과 재질 설명",
      "disposalMethod": "재활용 수거함에 버리세요"
    }
  ]
}`;
